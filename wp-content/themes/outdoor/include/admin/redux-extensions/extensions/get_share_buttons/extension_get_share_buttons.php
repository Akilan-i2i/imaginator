...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_Extension_get_share_buttons' ) ) {
    /**
     * Main ReduxFramework custom_field extension class
     *
     * @since       3.1.6
     */
    class ReduxFramework_Extension_get_share_buttons extends ReduxFramework {
        // Protected vars
        protected $parent;
        ...
        public function __construct( $parent ) {
            ...
            $this->field_name = 'get_share_buttons';
