...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_Extension_od_social_buttons' ) ) {
    /**
     * Main ReduxFramework custom_field extension class
     *
     * @since       3.1.6
     */
    class ReduxFramework_Extension_od_social_buttons extends ReduxFramework {
        // Protected vars
        protected $parent;
        ...
        public function __construct( $parent ) {
            ...
            $this->field_name = 'od_social_buttons';
